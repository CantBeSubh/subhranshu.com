  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        ...
        since my sophomore year and I am excited to lead the frontier for{" "}
        <span className="font-medium">AI-enabled Nuclear Compliance</span>. At
        Everstar, we are crafting{" "}
        <span className="text-lg font-medium text-violet-500">
          intelligent systems designed to supercharge the end-to-end workflows
          for nuclear innovators
        </span>
